...
void main() => runApp(AppTaller());

class AppTaller extends StatelessWidget {
  @override
...
class PrimeraPagina extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Flutter taller firebase'),
      ),
      body: AppFirebase(),
    );
  }
        ...
        child: Column(
          children: <Widget>[
            ...
            TextFormField(
              ...
              decoration: InputDecoration(helperText: 'apellido'),
              validator: (valor) {
                if (valor.isEmpty) {
                  return 'Els valor esat vacio';
                }
              ...
              onPressed: () {
                if (_key.currentState.validate()) {
                  Firestore.instance.collection('usuarios').document().setData(
                      {'nombre': _nombre.text, 'apellido': _apellido.text});
                }
              },
            ...
            return ListView(
              children:
                ...
                return ListTile(
                  ...
                  subtitle: Text(document['apellido']),
